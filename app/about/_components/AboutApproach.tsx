 ...
 useGSAP(
  ...
  return (
    <section ref={containerRef} className="relative overflow-hidden bg-navy py-28 text-white font-body">
      ...
      <div className="absolute -top-40 -right-40 size-96 rounded-full bg-cherry/70 blur-3xl pointer-events-none" />
      <div className="absolute -bottom-40 -left-40 size-96 rounded-full bg-cherry/40 blur-3xl pointer-events-none" />

      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          
          <div className="approach-left will-change-transform">
            <span className="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-xs font-semibold tracking-widest uppercase text-cherry">
              Our Approach
            </span>
            <h2 className="font-heading mt-6 text-4xl font-bold leading-tight lg:text-5xl">
              Strategic Platforms. <br />
              Seamless Execution. <br />
              <span className="bg-gradient-to-r from-cherry via-cherry to-cherry-light bg-clip-text text-transparent">Real Business Value.</span>
            </h2>
          ...
          <div className="approach-right will-change-transform">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-10 backdrop-blur-xl shadow-xl">
              <div className="font-heading mb-4 text-5xl font-bold leading-none text-cherry">“</div>
